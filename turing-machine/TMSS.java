...
/**
 * Two-sided infinite tape Turing Machine compiler/simulator.
 * 
...
public class TMSS {
	...
	public static final String SAVE = "save", STDIN = "stdin";

	public static final String TRUE_1 = "t", TRUE_2 = "true", FALSE_1 = "f", FALSE_2 = "false";
	...
	public static String formatTime(long time, boolean shortForm) throws IllegalArgumentException {
		...
		final int millis = (int) (time % TMSS.MILLISECONDS_PER_SECOND);
